; ==================================================================
; The Onem16 Boot Loader
; 2011 Primis Computers 
; Revised By Nick Sargente
;
; Based on a free boot loader by E Dehling. It scans the FAT12
; floppy for KERNEL.BIN (the kernel), loads it and executes it.
...
OEMLabel		db "ONEM16OS"	; Disk label
...
VolumeLabel		db "ONEM16 BOOT"; Volume Label: any 11 chars
...
load_file_sector:
	...
	; do a bit of math to work out whether we're dealing with a byte
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  BIN"	; Apollo kernel filename

	disk_error	db "Floppy error! Press any key...", 0
	file_not_found	db "Onem16 Kernel not found!", 0
